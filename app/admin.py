...
class ThongTinSachView(ModelView):
    ...
    column_labels = dict(id="Mã sách", tenSach="Tên sách", theLoai="Thể loại", tacGia="Tác giả",
                         ...
                         tinhTrangSach="Tình trạng sách", nhanvien="Nhân viên", HinhAnh="Hình Ảnh" ,theDocGia="Thẻ độc giả")
    column_sortable_list = ['id', 'tenSach', 'theLoai', 'tacGia',
                            'namXuatBan', 'nhaXuatBan', 'ngayNhap', 'triGia','HinhAnh',
...
admin.add_view(trangChu(name="Quay Về trang Web"))
